...
export const REPOSITORY = {
    URL: 'https://github.com/openhoangnc/sift',
    TRACKERS_DB: 'https://github.com/openhoangnc/sift/tree/main/web/client/src/helpers/trackers/trackers.json',
    ISSUES: 'https://github.com/openhoangnc/sift/issues/new/choose',
};

export const CLIENT_ID_LINK = 'https://github.com/openhoangnc/sift/blob/main/docs/clients.md#clientid';
export const MANUAL_UPDATE_LINK = 'https://github.com/openhoangnc/sift/blob/main/docs/faq.md#manual-update';
export const PORT_53_FAQ_LINK = 'https://github.com/openhoangnc/sift/blob/main/docs/faq.md#address-already-in-use';
export const PRIVACY_POLICY_LINK = 'https://github.com/openhoangnc/sift/blob/main/docs/privacy.md';
export const UPSTREAM_CONFIGURATION_WIKI_LINK = 'https://github.com/openhoangnc/sift/blob/main/docs/configuration.md#upstreams';
