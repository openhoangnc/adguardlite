...
const Dashboard = ({
    ...
    // Same guard the DNS settings page puts on this: emptying the cache is one
    // click away from the refresh button, and the two are not undoable alike.
        ...
        <>
            <PageTitle title={t('dashboard')} containerClass="page-title--dashboard">
                ...
                <div className="page-title__actions">
                    <button
                        type="button"
                        data-testid="dashboard_refresh_stats"
                    ...
                    <button
                        type="button"
                        data-testid="dashboard_clear_cache"
