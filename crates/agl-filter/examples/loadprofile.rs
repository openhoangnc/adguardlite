...
//!
//! Usage: cargo run --release -p agl-filter --example loadprofile -- <dir of .txt>

use std::time::Instant;

use agl_filter::engine::Engine;
use agl_filter::rule::{MIN_SHORTCUT_LEN, Pattern, Rule, parse};
...
fn main() {
    ...
    for (label, name) in [
        ...
        let req = agl_filter::engine::Request {
            hostname: name,
            qtype: 1,
            client_ip: None,
            client_name: None,
